...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Gourav Yadav", "http://www.iamgourav.com",
			"gourav@gmail.com");

	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Comment API", "Comment Related Functions", "1.0",
